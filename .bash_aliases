...
alias hsi='history | grep -i'   # Ищет в истории команд по без учета регистра.
...
alias dus='du -h --max-depth=1 | sort -rh' # Показывает суммарный размер каждого файла и каталога в текущей директории, отсортированный по убыванию.
